...
| C-010 | Bel Fiore | cível | não registrado | não registrado | ~R$ 70.000 | **sentença de improcedência total em 1º grau** — definir recurso | ativo — ⚠️ decisão adversa |
...
| C-004 | 🚨 Manifestação mov. 58 (indicar bens **sob pena de extinção**) — Gracielle | 2026-07-17 — **VENCIDO HÁ 5 DIAS (hoje 2026-07-22)** | Protocolar manifestação: SISBAJUD teimosinha (principal) + subsidiário (suspensão art. 921, III, CPC / extinção com ressalva do crédito e reingresso pelo acordo homologado). DOCX+PDF gerados em `Escritorio/Peticoes/2026-07-17_auris_x_gracielle_manifestacao_prosseguimento.*` | 🚨 **peça gerada mas NÃO confirmada como protocolada — VERIFICAR AGORA** |
...
| C-010 | 🔴 **Apelação** (se Bel Fiore for a parte sucumbente) | **CONFIRMAR — 15 dias úteis da intimação da sentença (CPC art. 1.003, §5º)** | Sentença de improcedência total em 1º grau. **Definir com urgência:** (a) Bel Fiore é requerente ou requerida? (b) data da intimação. Se requerente → prazo de apelação correndo. Nomenclatura de 2ª instância: apelante/apelada | **não — VERIFICAR HOJE** |
