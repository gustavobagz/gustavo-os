...
| C-020 | Lusterfon Rodrigues do Couto (CPF 055.413.811-50) — **possível cliente** | cível — indenização (cumprimento de sentença, réu solidário) | Vara Cível de Abadiânia/GO | 0080970-36.2015.8.09.0001 | débito exequendo R$ 20.481,27 (mov. 299) | Réu solidário (8 réus originais) que **não integrou** o acordo de parcelamento fechado por outros 4 (Wallace, Sebastião, Erineas, Johnathan) em 2026-06-09. Sentença de 2026-07-22/23 homologou esse acordo e **JULGO EXTINTO O PROCESSO** (art. 487, III, "b", CPC), sem ressalva textual quanto aos demais réus, trânsito em julgado imediato, com baixa de restrições. **Análise da sentença (2026-07-23):** dispositivo fala do processo como um todo, não "quanto aos 4 signatários" — dúvida real se a extinção alcança o Lusterfon por arrastamento (coisa julgada, arts. 502/508 CPC) ou se ele segue exposto a cobrança em separado. Em QUALQUER cenário, pelo art. 277 CC (transação de codevedor solidário só extingue a dívida "na parte a ele correspondente", prosseguindo a solidariedade dos demais "pelo resto"), ele **nunca deve o valor cheio de R$ 20.481,27** — no máximo uma fração residual. Prazo do Lusterfon já havia decorrido em 2026-06-23 sem contestar/pagar; SISBAJUD contra ele retornou R$ 0; CPF negativado (SPC/Serasa) | avaliação preliminar — sem contrato |
...
| C-020 | 🔴 Prazo de embargos de declaração do exequente (5 dias úteis da publicação) | ~2026-07-29 (confirmar data exata de publicação) | Se o exequente perceber a ambiguidade e não embargar pedindo ressalva quanto ao Lusterfon dentro do prazo, a leitura ampla (extinção alcança todos os réus) se consolida. Monitorar movimentação do processo nesse intervalo | não |
| C-020 | Confirmar Lusterfon como cliente (procuração) antes de peticionar qualquer coisa | não registrado | Sem procuração assinada, nenhuma manifestação pode ser protocolada em nome dele. Decidir com ele entre (a) silêncio estratégico até o prazo de embargos passar, ou (b) petição proativa pedindo declaração de que a extinção o alcança — ciente de que isso também avisa o exequente da ambiguidade | não |
