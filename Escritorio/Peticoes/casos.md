...
| C-014 | João Pedro Silva Gomes × FAMP — ProUni | mandado de segurança | a definir | **não protocolado** | não registrado | Indeferimento 2026-04-17 (Edital 2/2026, medicina). Procuração de 2026-04-22 c/ poderes p/ MS com liminar; DOC.01–16 prontos | ⏰ **crítico — decadência ~2026-08-15** |
...
| C-016 | Tercília Pereira da Silva e Paulo Sergio Santana — RHC ao STJ | criminal (RHC) | STJ (via TRF1) | HC 1012203-98.2026.4.01.0000 · originário 0005550-23.2014.4.01.3200 | — | Acórdão denegatório do TRF1 em 2026-04-28. Minuta pronta, **não protocolada**. Patrono: Chrystiano Silva Martins (OAB/GO 21.204) — Gustavo faz a análise técnica | ⏰ prazo de 5 dias |
...
| C-014 | 🔴 **Protocolar MS ProUni — João Pedro** | **~2026-08-15** | Decadência de 120 dias do indeferimento (2026-04-17). DOC.01–16 e procuração prontos, falta protocolar | **não** |
| C-016 | 🔴 **RHC / EDcl — Tercília e Paulo** | 5 dias da publicação | Acórdão denegatório em 2026-04-28. Decidir entre opor EDcl antes ou ir direto ao RHC. **Confirmar publicação para contagem** | **não** |
