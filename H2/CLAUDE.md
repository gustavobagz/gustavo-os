# CLAUDE.md — H2 Soluções em Saúde (Frente 1)

> Contexto exclusivo da H2. Vale para tudo dentro de `H2/`. Não misturar com
> a prática independente (`Escritorio/`) — clientes, honorários e casos do
> escritório NUNCA entram nos registros da H2, e vice-versa.

## Meu papel na H2
Responsável jurídico-estratégico. Empresa de gestão/staffing médico, atuação
multi-estadual. Advisor jurídico-negocial-estrutural (três lentes: jurídica,
de negócio, estrutural). Também contador-consultor integrado (Lucro Presumido,
equiparação hospitalar, matérias fiscais correlatas).
E-mail da frente H2: controladoria@h2saude.com.br.
...
- Painel administrativo (em avaliação/estruturação) — deve linkar pros 4 acima
