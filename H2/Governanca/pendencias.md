...
| Livros societários | Alta | **Reconstrução concluída em 2026-07-23**: 498 dos 533 CPF/CNPJ pendentes resolvidos (22 rodadas de busca individual); os 2 CPFs com dígito inválido (Jucelio Lima Martins, Phellipe Di Monaco Lima) corrigidos e validados; duplicidade RV Medcare resolvida (rodada 20); 120 saídas confirmadas que ainda constavam ativas foram zeradas (56 na rodada 24 + 64 na rodada 26, com arquivo de controle atualizado do Downloads). **Livro de Registro de Ações Nominativas fechado** com 2.197 acionistas / 21.620 ações em `H2/Governanca/2026-07-23-LIVRO-REGISTRO-ACOES-NOMINATIVAS-H2SA.xlsx`, consolidado no livro oficial `2026-07-23-LIVRO-OFICIAL-REGISTRO-ACOES-NOMINATIVAS-H2SA.docx` (assinatura só do Guilherme, sem menção aos 35 pendentes por decisão do Gustavo) e Livro de Transferência de Ações Nominativas em `2026-07-23-LIVRO-TRANSFERENCIA-ACOES-NOMINATIVAS-H2SA.xlsx` (parcial — ver ressalva abaixo). 35 pendentes remanescentes isolados em `2026-07-23-PENDENTES-35-livro-acionistas.xlsx` (fora do livro, em stand by). 23 pedidos de saída ainda em andamento (status enviado/solicitado, não confirmados) ficam para monitoramento — ver Rodada 26. Detalhe completo: `H2/Governanca/livro-acionistas.md`, Rodadas 23-26 | **Gustavo: (1) colher a assinatura do Guilherme para efetivamente fechar o livro; (2) CPF certo de Marta de Pinho Alcântara, Ianara Janaina de Araujo Tavares Xavier, Caroline Urzedo Severino, Kelly Vieira Prates, Julia Ceconello Coelho, Andrea dos Santos Carvalho, Leonardo Furno Petraglia (ainda não tratado); (3) monitorar os 23 pedidos de saída em andamento (reconsultar o arquivo de controle mais recente, nao uma copia antiga) e zerar quando confirmados; (4) decidir se/quando retomar busca dos 35 pendentes** |
| **Levantamento de Termos de Transferência/Cessão não catalogados** | Alta | Workflow de 44 agentes (2026-07-23, rodada 28) levantou **562 Termos únicos** (nº 4 a nº 3435) — cobertura estimada ~16% do total (a numeração já passa de 3.400). Gaps conhecidos: 1 mês (abril/2026) falhou tecnicamente sem cobertura nenhuma; ao menos 2 janelas de upload em massa tiveram busca incompleta ("amostra parcial"); maior buraco na sequência é nº 1161-1503 (342 números). Livro de Transferência em `2026-07-23-LIVRO-TRANSFERENCIA-ACOES-NOMINATIVAS-H2SA.xlsx` já reflete os 562, com aviso explícito de que é piso, não total. Detalhe completo: `H2/Governanca/livro-acionistas.md`, Rodada 28 | **Gustavo: decidir se vale investir numa segunda rodada com fatias mais finas (semanais/diárias) pra cobrir abril/2026 e as janelas parciais, ou aceitar cobertura parcial por ora** |
| **Achado estrutural — capital social pode estar sendo excedido** | Alta | Ata de Constituição (2023-12-01): capital original de 10.000 ações (Jair 7.000/70%, Guilherme 3.000/30% — únicos 2 fundadores, confirmado). AGE de 2024-11-12 aumentou para 500.000 ações "mantendo a proporção prévia", mas **listou como "totalidade dos acionistas" só Jair e Guilherme** — quando o programa de distribuição de 10 ações/médico já rodava desde jan/2024 (Termo nº 4, dez/2023). Isso, somado ao fato já registrado de que o aumento de capital nunca foi refletido na contabilidade (capital subscrito ainda em R$10.000 no balanço), sugere que a H2 pode estar transferindo/emitindo mais "ações" via Termos do que o capital social formalmente autorizado suporta — questão de validade da emissão (arts. 166/170 Lei 6.404/76), não só de organização de planilha | **Gustavo: avaliar com a SDBM se os médicos-acionistas deveriam constar como acionistas nas AGEs (risco de anulabilidade das deliberações) e reconciliar o total de "ações" já transferidas via Termos (562 levantados até agora, real provavelmente >3.400) contra o capital formalmente subscrito** |
...
|------|---------|-----|------|
| 2026-07-24, 9h | Faturamento e desenquadramento do lucro presumido — prep em [[2026-07-24-prep-reuniao-desenquadramento-lucro-presumido]] | Amaral e Puga | Google Calendar |
