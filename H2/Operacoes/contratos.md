...
| Contrato | Contratante | Objeto | Vigência (início → fim) | Valor | Status |
|----------|-------------|--------|--------------------------|-------|--------|
| não registrado | SBCD (HMC) | Médico Intensivista Adulto | 2024-03-14 → não registrado | não registrado | ativo |
| não registrado | SBCD (HMC) | Médico Hospitalista/Infectologista | 2024-01-16 → não registrado | não registrado | ativo |
| não registrado | UPA Pinhais / S3 | não registrado | expirado recentemente | não registrado | **renovação em andamento** |
| não registrado | HRCM / SBCD | não registrado | expirado recentemente | não registrado | **renovação em andamento** |
| 101/2024 | Marabá | não registrado | não registrado | não registrado | pendente rodar no precificador — sem registro no histórico; detalhar via painel jurídico |
